                    ...
                    <div className="lg:text-center px-4 ">
                        ...
                        <div className="grid grid-cols-4 max-md:grid-cols-1 gap-8 mb-16 px-4">
                            <div className='flex flex-col items-center text-center'>
                                <img src={icon1} alt="Local Expertise" className='p-6' />
                            ...
                            <div className='flex flex-col items-center  text-center'>
                                <img src={icon2} alt="Proven Track Record" className='p-6'></img>
                            ...
                            <div className='flex flex-col items-center text-center'>
                                <img src={icon3} alt="Holistic Solutions" className='p-6'></img>
                            ...
                            <div className='flex flex-col items-center text-center'>
                                <img src={icon4} alt="Dedicated Support" className='p-6'></img>
