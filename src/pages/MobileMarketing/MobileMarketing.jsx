    ...
    const tabData = [
        ...
        return (
            ...
            <div className="mmc1 relative ">
                ...
                <div className="mmc4 flex flex-col justify-center items-center mx-auto mt-[60px] mb-[60px]">
                <div className="bg-black px-6 py-10 text-center">
                    <h2 className="text-[48px] font-semibold text-white mb-[64px] mt-[64px] mx-auto w-[70%]">
                    ...
                    {tabData.map((tab, index) => (
                        ...
                        className={`text-white px-4 py-2 mx-2 border-b-2 transition-all duration-300 ${
                            activeIndex === index ? "border-green-400" : "border-transparent hover:border-gray-500"
                        }`}
                        >
                        {tab.label}
                        </button>
                    ...
                    {/* Animated Content */}
                   <div className="flex flex-row max-w-5xl mx-auto mt-[96px] text-left text-white ">
                        <motion.div
                            key={activeIndex + "-content"}
                            initial={{ opacity: 0, y: 50 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.5, ease: "easeOut" }}
                            className="flex-1 pr-6 mr-10"
                        >
                            <div className="whitespace-pre-line">{tabData[activeIndex].content}</div>
                        </motion.div>
                ...
                <div className="mmc5">
                    <div className="text-center px-4 py-16">
                        <h2 className="text-[52px] font-bold mb-6">
                        ...
                        <div className="grid grid-cols-4 md:grid-cols-4 gap-8 mb-16 px-4">
