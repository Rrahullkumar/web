...
"
        ...
        <div className=" container lgc2 px-10 max-lg:px-4 flex flex-col justify-center items-center mx-auto">
        ...
        <div className="lgc3 container mt-[50px] mx-auto flex max-lg:block flex-row px-10 max-lg:px-4 h-[555px] max-lg:h-auto justify-between">
        ...
        <div className="lgc4 container px-10 max-lg:px-4 flex flex-col justify-center items-center  mx-auto mt-[60px] mb-[60px]">
...
/>
        ...
        <div className="flex flex-col container px-10 max-lg:px-4 justify-center items-center mx-auto mt-[60px] mb-[96px]">
        ...
        <div className="lgc5 mt-[40px] container flex flex-col px-10 max-lg:px-4 justify-center items-center mx-auto mb-24 max-lg:mb-10">
        ...
        <div className="lgc7 mt-[96px] max-lg:mt-10 container mx-auto px-10 max-lg:px-4">
