...
const AboutUS = () => {
  ...
  return (
    <div className=" max-lg:mt-[50px]">
      ...
      <h4 className='text-center   text-[52px] lg:pt-[60px] mb-[20px]  max-lg:text-[38px]   leading-[100%]'> <span className='font-semibold text-green-500'> About </span> <span className='font-normal text-black'>US</span> </h4>
      ...
      <section className="max-w-[1440px] mt-[96px] max-md:mt-[50px] w-full mx-auto pl-[40px] pr-[40px] max-lg:pl-[16px] max-lg:pr-[16px]  text-left  flex flex-col md:flex-row items-center  gap-[106px] max-lg:gap-5  overflow-hidden">
        <div className="max-w-2xl  max-md:w-[100%]"
          ...
          data-aos-delay="100"
        >
          <h1 className="text-[48px] max-md:text-center max-lg:text-[34px] leading-[120%] font-semibold text-[#000000]  mb-4 max-lg:mb-8">
            Few Words About WebNest Media
          </h1>
          <p className=" text-[black] text-base max-md:text-base mb-4 max-md:text-center max-md:mb-2">
          ...
          <p className=" text-[#000000] text-base max-md:text-center max-md:text-base ">
      ...
      <section className=" overflow-hidden max-w-[1440px] w-[100%]  mx-auto pl-[40px] pr-[40px] max-lg:pl-[16px] max-lg:pr-[16px] text-center mt-[96px] mb-[96px] max-md:mt-[50px]" ref={wrapperRef}
      ...
      <section className=" max-w-[1440px] w-[100%] mx-auto text-center pl-[40px] pr-[40px] max-lg:pl-[16px] max-lg:pr-[16px] pb-10  relative z-10">
        ...
        <p className="max-w-2xl mx-auto text-base  text-gray-600 mt-4">
    ...
    ">
        ...
        <div className="max-w-2xl max-md:w-[100%]">
          <h2 className="text-[52px] max-lg:text-[38px] max-lg:text-center font-semibold text-gray-900 mb-8">
            Our Key to Excellence
          </h2>
          <p className=" text-gray-700 text-base max-md:text-center mb-4">
      ...
      <section className='mt-[96px] max-w-[1440px] w-[100%] mx-auto pl-[40px] pr-[40px] max-lg:pl-[16px] max-lg:pr-[16px] '>
        ...
        <p className='text-base text-black font-light text-center mt-[32px] lg:mb-[96p`x] mb-10 '> Whether you're looking to boost your search rankings, engage your social audience, or develop a comprehensive <br className='max-lg:hidden' /> digital strategy, WebNest Media is here to help.</p>
