...
<meta property="og:title" content="Market Research and Insights Company in Gurgaon | WebNest Media " />
 ...
 <meta property="og:site_name" content="WebNest Media" />
    ...
    <div className=' ' >
      ...
      />
      <div className="mr1 max-w-[1440px] w-[100%] mx-auto flex flex-row max-md:flex-col px-[40px] max-md:px-[16px] items-center gap-4 mt-24">

        {/* Left Section */}
        <div className="mr1left w-[60%] max-md:w-[100%]">

          {/* Heading */}
          <h2 className='text-[52px] font-semibold max-md:text-[36px] mb-[36px]'>
      ...
      <div className="mr2 max-w-[1440px] px-[40px] max-md:px-[16px] w-[100%] mx-auto flex flex-col justify-center items-center mt-[96px]">
        <h2 className='text-[52px] max-md:text-[36px] font-semibold text-center lg:w-[50%] mb-14'>Importance of Market Research & Insights</h2>
      ...
      <section className='max-w-[1440px] px-[40px] max-md:px-[16px] mx-auto max-lg:mt-[40px]'>
        <div className=''>
          <h2 className='text-[52px] max-md:text-[34px] lg:w-[40%] font-semibold mb-16 max-lg:mb-10 lg:translate-y-36 '>How We Collect the Right Data</h2>
