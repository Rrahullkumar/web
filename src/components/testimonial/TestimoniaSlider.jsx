        ...
        <section className="py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-16">
                    ...
                    <h2 className="text-4xl text-center font-bold text-gray-900">{sectionTitle}</h2>
                </div>
                ...
                >
                    {testimonials.map((item, index) => (
                        <SwiperSlide key={index}>
                            <div className="group bg-white border border-gray-300 rounded-xl p-6 transition-all duration-500 w-full mx-auto min-h-[400px] flex flex-col">
                                {/* Fixed Top Section */}
                                <div>
                                    <div className="flex items-center mb-4 gap-2 text-amber-500">
