...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    return (
       <div className="conatctform p-[40px] rounded-[20px] shadow-[0_12px_20px_rgba(0,0,0,0.2)]">


        <p className=" text-[#409338] font-bold text-[30px] max-sm:text-[28px] leading-[40px]  text-center stroke-custom fill-custom">
