 ...
 <div className='mt-[120px] pl-[40px] pr-[40px] max-lg:pl-[16px] max-lg:pr-[16px]'>
   ...
   <strong>Privacy Policy</strong>
      ...
      <ul>
        ...
        <li>
          <p><strong>Website</strong> refers to Webnest Media, accessible from <a href="https://webnestmedia.com/" rel="external nofollow noopener" target="_blank"
          
                   aria-label="WebNest Media Website"

          >https://webnestmedia.com/</a></p>
        </li>
        <li>
